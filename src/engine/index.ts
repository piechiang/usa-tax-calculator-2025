...
// Rules exports for 2025 (default)
...
// Calculator exports
export { computeFederal } from './federal/computeFederal';
export {
  computeMD,
  isMarylandResident,
  getMarylandCounties,
  getMDLocalRate
} from './states/md/computeMD';
export { computeFederal2025 } from './federal/2025/computeFederal2025';
export { computeMD2025 } from './states/md/2025/computeMD2025';
...
// Standard deductions for 2026 (converted to cents)
...
export const SALT_CAP_2026 = dollarsToCents(10000);
...
// Personal exemption (suspended for 2018-2026)
export const PERSONAL_EXEMPTION_2026 = 0;

// Itemized deduction phaseout thresholds (suspended for 2018-2026)
export const ITEMIZED_DEDUCTION_PHASEOUT_2026 = {
  enabled: false,
  thresholds: {

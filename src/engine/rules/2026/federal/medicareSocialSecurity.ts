...
// Social Security wage base for 2026 (SSA)
export const SS_WAGE_BASE_2026 = 17610000; // $176,100

// Additional Medicare Tax thresholds for 2026 (0.9% on earnings above threshold)
// Source: IRS Topic 560
export const ADDL_MEDICARE_THRESHOLDS_2026: Record<FilingStatus, number> = {
...
// Net Investment Income Tax (NIIT) thresholds for 2026 (3.8% on investment income)
// Source: IRS Form 8960
export const NIIT_THRESHOLDS_2026: Record<FilingStatus, number> = {
  single: 20000000,             // $200,000
  headOfHousehold: 20000000,    // $200,000
  marriedJointly: 25000000,     // $250,000
  marriedSeparately: 12500000,  // $125,000

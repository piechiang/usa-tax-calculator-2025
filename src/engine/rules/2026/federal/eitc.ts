// FilingStatus is used in computeEITC2026 parameter types

// EITC parameters for 2026 (Rev. Proc. 2024-40 §2.06)
...
// Investment income limit for EITC eligibility in 2026
export const EITC_INVESTMENT_INCOME_LIMIT_2026 = 1195000; // $11,950

export const EITC_2026: Record<EITCQualifyingChildren, EITCTableRow> = {
  0: { 

...
// Social Security wage base for 2024 (SSA)
export const SS_WAGE_BASE_2024 = 17610000; // $176,100

// Additional Medicare Tax thresholds for 2024 (0.9% on earnings above threshold)
// Source: IRS Topic 560
export const ADDL_MEDICARE_THRESHOLDS_2024: Record<FilingStatus, number> = {
...
// Net Investment Income Tax (NIIT) thresholds for 2024 (3.8% on investment income)

...
// Standard deductions for 2024 (converted to cents)
...
export const SALT_CAP_2024 = dollarsToCents(10000);
...
// Personal exemption (suspended for 2018-2024)
export const PERSONAL_EXEMPTION_2024 = 0;

// Itemized deduction phaseout thresholds (suspended for 2018-2024)
export const ITEMIZED_DEDUCTION_PHASEOUT_2024 = {
  enabled: false,
  thresholds: {

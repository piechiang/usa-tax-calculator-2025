// FilingStatus is used in computeEITC2024 parameter types

// EITC parameters for 2024 (Rev. Proc. 2024-40 §2.06)
...
// Investment income limit for EITC eligibility in 2024
export const EITC_INVESTMENT_INCOME_LIMIT_2024 = 1195000; // $11,950

export const EITC_2024: Record<EITCQualifyingChildren, EITCTableRow> = {
  0: { 

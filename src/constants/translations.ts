...
export const translations: Translations = {
  en: {
    ...
    modernMode: {
      ...
      welcomeDescription: "Our intelligent wizard guides you through your tax return step-by-step, ensuring you don't miss deductions and credits while keeping everything simple.",
  ...
  zh: {
    ...
    modernMode: {
      welcome: "欢迎使用智能税务申报",
      welcomeDescription: "我们的智能向导将逐步引导您完成税务申报，确保您不会错过任何扣除额和抵免额，同时让一切保持简单。",
      smartGuidance: "智能指导",
  ...
  es: {
    ...
    modernMode: {
      ...
      welcomeDescription: "Nuestro asistente inteligente lo guiará paso a paso en su declaración de impuestos, asegurándose de que no se pierda deducciones y créditos mientras mantiene todo simple.",

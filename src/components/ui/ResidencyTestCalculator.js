...
import { Card, Form, Input, Button, Typography, Alert, Divider, Space, Tooltip } from 'antd';
...
const ResidencyTestCalculator = ({ onResult, defaultValues = {} }) => {
  ...
  const getExplanation = (isResident, weightedDays, currentYearDays) => {
    if (isResident) {
      return {
        status: 'resident',
        title: '你被认定为美国税务居民',

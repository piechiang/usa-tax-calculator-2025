/**
 * Mississippi (MS) Tax Calculation Tests - 2025
 *
 * Tests Mississippi's state tax system.
 */

import { describe, it, expect } from 'vitest';
import { computeMS2025 } from '../../../../../src/engine/states/MS/2025/computeMS2025';
...
describe('Mississippi 2025 Tax Calculations', () => {
  it('Single filer - Basic scenario', () => {
    ...
    const result = computeMS2025(stateInput);

/**
 * Montana (MT) Tax Calculation Tests - 2025
 *
 * Tests Montana's state tax system.
 */

import { describe, it, expect } from 'vitest';
import { computeMT2025 } from '../../../../../src/engine/states/MT/2025/computeMT2025';
...
describe('Montana 2025 Tax Calculations', () => {
  it('Single filer - Basic scenario', () => {
    ...
    const result = computeMT2025(stateInput);

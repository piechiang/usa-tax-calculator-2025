/**
 * Kansas (KS) Tax Calculation Tests - 2025
 *
 * Tests Kansas's state tax system.
 */

import { describe, it, expect } from 'vitest';
import { computeKS2025 } from '../../../../../src/engine/states/KS/2025/computeKS2025';
...
describe('Kansas 2025 Tax Calculations', () => {
  it('Single filer - Basic scenario', () => {
    ...
    const result = computeKS2025(stateInput);

/**
 * Rhode Island (RI) Tax Calculation Tests - 2025
 *
 * Tests Rhode Island's state tax system.
 */

import { describe, it, expect } from 'vitest';
import { computeRI2025 } from '../../../../../src/engine/states/RI/2025/computeRI2025';
...
describe('Rhode Island 2025 Tax Calculations', () => {
  it('Single filer - Basic scenario', () => {
    ...
    const result = computeRI2025(stateInput);

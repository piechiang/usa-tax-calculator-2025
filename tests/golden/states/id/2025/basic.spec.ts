/**
 * Idaho (ID) Tax Calculation Tests - 2025
 *
 * Tests Idaho's state tax system.
 */

import { describe, it, expect } from 'vitest';
import { computeID2025 } from '../../../../../src/engine/states/ID/2025/computeID2025';
...
describe('Idaho 2025 Tax Calculations', () => {
  it('Single filer - Basic scenario', () => {
    ...
    const result = computeID2025(stateInput);

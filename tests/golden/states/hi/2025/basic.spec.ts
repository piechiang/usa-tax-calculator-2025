/**
 * Hawaii (HI) Tax Calculation Tests - 2025
 *
 * Tests Hawaii's state tax system.
 */

import { describe, it, expect } from 'vitest';
import { computeHI2025 } from '../../../../../src/engine/states/HI/2025/computeHI2025';
...
describe('Hawaii 2025 Tax Calculations', () => {
  it('Single filer - Basic scenario', () => {
    ...
    const result = computeHI2025(stateInput);

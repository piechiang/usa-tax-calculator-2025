/**
 * Maine (ME) Tax Calculation Tests - 2025
 *
 * Tests Maine's state tax system.
 */

import { describe, it, expect } from 'vitest';
import { computeME2025 } from '../../../../../src/engine/states/ME/2025/computeME2025';
...
describe('Maine 2025 Tax Calculations', () => {
  it('Single filer - Basic scenario', () => {
    ...
    const result = computeME2025(stateInput);

/**
 * Vermont (VT) Tax Calculation Tests - 2025
 *
 * Tests Vermont's state tax system.
 */

import { describe, it, expect } from 'vitest';
import { computeVT2025 } from '../../../../../src/engine/states/VT/2025/computeVT2025';
...
describe('Vermont 2025 Tax Calculations', () => {
  it('Single filer - Basic scenario', () => {
    ...
    const result = computeVT2025(stateInput);
